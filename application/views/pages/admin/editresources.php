...
<?php $this->load->view('pages/admin/admin_menu'); ?>
                                ...
                                <div class="tab-content clearfix">
                                    <div class="tab-pane active" id="1a">
                                        <a href="<?php echo base_url(); ?>admin/addresource" class="btn btn-primary pull-right" style="margin: 10px;">+Add Resource</a>
                                        <div class="row col-md-7 col-md-offset-3">
                                            <h2>Edit Resource</h2>
                                            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/editresource/'.$id;?>" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-10">
                                                    <select  class="form-control" id="type" required name="type" >
                                                        <option value="<?php echo $eads[0]->type;?>"><?php echo $eads[0]->r_type;?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="title" value="
                                                         <?php 
                                                         if (strpos($eads[0]->link, 'uploads') !== false) {
                                                             echo 'Uploaded Document';
                                                         }else{
                                                             echo $eads[0]->link;
                                                                     
                                                         };?>
                                                           " placeholder="Bible verse reference e.g. 2 Peter 1:3-9 or resource title" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <textarea name="description" class="form-control" placeholder="Bible verse itself or small description of the resource" required><?php echo $eads[0]->body;?></textarea>
                                                </div>
                                            </div>
