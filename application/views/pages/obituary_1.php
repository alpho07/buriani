...
<div class="row">
    <form id="smart-form" method="POST" enctype='multipart/form-data' action="<?php echo base_url() . 'home/uploadIdScan/nQo122jq2'; ?>">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 register-account card">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <select class="chosen-select-search" readonly name="category" id="category" required value="<?php echo isset($_POST['category']) ? $_POST['category'] : '' ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <textarea name="description" name="description" id="description" required ><?php echo isset($_POST['description']) ? $_POST['description'] : '' ?></textarea>
                    </div>	
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <textarea name="more_info"  placeholder="e.g. Arranged meeting place, paybill number for money collection and mini program" ><?php echo isset($_POST['more_info']) ? $_POST['more_info'] : '' ?></textarea>
                    </div>	
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <p>Upload Copy of Your Scanned ID</p>
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <div class="" style="color:red; font-weight: bold; " > <?php echo @$error1; ?></div>

                        <p><input type="file" id="idcopy"   name="idcopy" required/></p>
